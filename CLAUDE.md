...
- `index.html` (~760 lines) — all markup: main form + feedback modal + formula modal + stopwatch modal + history/compare modal + Time Study config modal + onboarding overlay + in-app numpad
