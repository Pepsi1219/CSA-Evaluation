...
export const translations = {
    'th': {
        ...
        'set_account': 'บัญชี',
        'account_signed_in_as': 'ลงชื่อเข้าใช้เป็น',
        'account_signout': 'ออกจากระบบ',
        'login_title': 'เข้าสู่ระบบ',
        'login_subtitle': 'ลงชื่อเข้าใช้เพื่อใช้งานเครื่องมือและดูประวัติของคุณ',
        'login_email_label': 'อีเมล',
        'login_email_ph': 'you@example.com',
        'login_password_label': 'รหัสผ่าน',
        'login_password_ph': 'รหัสผ่านของคุณ',
        'login_signin_btn': 'เข้าสู่ระบบ',
        'login_signing_in': 'กำลังเข้าสู่ระบบ…',
        'login_offline_note': 'ต้องมีอินเทอร์เน็ตในการเข้าสู่ระบบครั้งแรก หลังจากนั้นใช้งานออฟไลน์ได้',
        'login_err_invalid': 'อีเมลหรือรหัสผ่านไม่ถูกต้อง',
    ...
    'en': {
        ...
        'login_title': 'Sign in',
        'login_subtitle': 'Sign in to use the tool and see your history',
        ...
        'login_offline_note': 'Internet is required to sign in the first time; after that the app works offline.',
    ...
    'vn': {
        ...
        'account_signed_in_as': 'Đăng nhập với',
        'account_signout': 'Đăng xuất',
        'login_title': 'Đăng nhập',
        'login_subtitle': 'Đăng nhập để sử dụng công cụ và xem lịch sử của bạn',
        'login_email_label': 'Email',
        'login_email_ph': 'you@example.com',
        'login_password_label': 'Mật khẩu',
        'login_password_ph': 'Mật khẩu của bạn',
        'login_signin_btn': 'Đăng nhập',
        'login_signing_in': 'Đang đăng nhập…',
        'login_offline_note': 'Cần Internet để đăng nhập lần đầu; sau đó ứng dụng hoạt động ngoại tuyến.',
        'login_err_invalid': 'Email hoặc mật khẩu không đúng.',
    ...
    'la': {
        ...
        'set_account': 'ບັນຊີ',
        'account_signed_in_as': 'ເຂົ້າສູ່ລະບົບເປັນ',
        'account_signout': 'ອອກຈາກລະບົບ',
        'login_title': 'ເຂົ້າສູ່ລະບົບ',
        'login_subtitle': 'ເຂົ້າສູ່ລະບົບເພື່ອໃຊ້ເຄື່ອງມື ແລະ ເບິ່ງປະຫວັດຂອງທ່ານ',
        'login_email_label': 'ອີເມວ',
        'login_email_ph': 'you@example.com',
        'login_password_label': 'ລະຫັດຜ່ານ',
        'login_password_ph': 'ລະຫັດຜ່ານຂອງທ່ານ',
        'login_signin_btn': 'ເຂົ້າສູ່ລະບົບ',
        'login_signing_in': 'ກຳລັງເຂົ້າສູ່ລະບົບ…',
        'login_offline_note': 'ຕ້ອງມີອິນເຕີເນັດເພື່ອເຂົ້າສູ່ລະບົບຄັ້ງທຳອິດ ຫຼັງຈາກນັ້ນໃຊ້ໄດ້ແບບອອບໄລນ໌',
        'login_err_invalid': 'ອີເມວ ຫຼື ລະຫັດຜ່ານບໍ່ຖືກຕ້ອງ',
